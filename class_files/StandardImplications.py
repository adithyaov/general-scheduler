class StandardImplications():
    ...
    def basic_implications(self):
        ...
        for (t, s, g, n, d, p2) in self.graph['xtsgndp'].keys():
            or_list = []
            for p1 in self.periods[d]:
                if bic2(t, s, g, n, d, p1, p2):
                    or_list.append(('x!tsgndp', (t, s, g, n, d, p1)))
            self.graph['xtsgndp'][(t, s, g, n, d, p2)].append(('or', or_list))
        ...
        for (t, s, g, n, d) in self.graph['xtsgnd'].keys():
            ...
            self.graph['xtsgnd'][(t, s, g, n, d)].append(('or', or_list))
        ...
        for (t, d, p) in self.graph['xtdp'].keys():
            ...
            self.graph['xtdp'][(t, d, p)].append(('or', or_list_t[(t, d, p)]))

        for (g, d, p) in self.graph['xgdp'].keys():
            self.graph['xgdp'][(g, d, p)].append(('or', or_list_g[(g, d, p)]))
        ...
        for (t, d) in self.graph['xtd'].keys():
            ...
            self.graph['xtd'][(t, d)].append(('or', or_list))
        ...
        for (t, p) in self.graph['xtp'].keys():
            ...
            for d in days:
                if bic3(d, p):
                    or_list.append(('xtdp', (t, d, p)))
            self.graph['xtp'][(t, p)].append(('or', or_list))
        ...
        for (k, t, d) in self.graph['iktd'].keys():
            ...
            self.graph['iktd'][(k, t, d)].append(('or', or_list))
        ...
        for (k, t) in self.graph['ikt'].keys():
            ...
            self.graph['ikt'][(k, t)].append(('or', or_list))
        ...
        for (t, d, p) in self.graph['itdp'].keys():
            ...
            for k in range(self.p_max):
                if bic12(k, d, p):
                    or_list.append(('iktdp', (k, t, d, p)))
            self.graph['itdp'][(t, d, p)].append(('or', or_list))
        ...
        for (k, g, d) in self.graph['ikgd'].keys():
            ...
            self.graph['ikgd'][(k, g, d)].append(('or', or_list))
        ...
        for (k, g) in self.graph['ikg'].keys():
            ...
            self.graph['ikg'][(k, g)].append(('or', or_list))
        ...
        for (g, d, p) in self.graph['igdp'].keys():
            ...
            for k in range(self.p_max):
                if bic12(k, d, p):
                    or_list.append(('ikgdp', (k, g, d, p)))
            self.graph['igdp'][(g, d, p)].append(('or', or_list))
    ...
    def correctness_implications(self):
        ...
        for (t, s, g, n) in self.duration.keys():
            ...
            self.true_list.append(('or', or_list))
